...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font bg-[url(https://i.ibb.co/6465PGS/footer.png)]">
      <div className="hero-overlay bg-white bg-opacity-80">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <Link to='' className="flex title-font font-bold items-center md:justify-start justify-center text-secondary">
            <span className="text-xl text-secondary font-bold">CareMark</span>
          </Link>
          <p className="mt-2 text-sm text-secondary">Air plant banjo lyft occupy retro adaptogen indego</p>
        </div>
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-bold text-secondary tracking-widest text-sm mb-3">CATEGORIES</h2>
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            ...
            <Link to='' className="ml-3 text-secondary">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
