...
const Carousel = () => {
    return (
        <div class="hero min-h-screen bg-[url(https://media.istockphoto.com/photos/modern-medical-clinic-picture-id1152845300?k=20&m=1152845300&s=612x612&w=0&h=izBnjD1RnZhaB4lR4eLKnlNazLUu0-3D7xrOvHXAU64=)]">
            <div class="hero-overlay bg-white bg-opacity-80"></div>
