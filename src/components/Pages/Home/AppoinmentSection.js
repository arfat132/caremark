    ...
    return (
        <div className="hero bg-[url(https://media.istockphoto.com/photos/empty-luxury-modern-hospital-room-picture-id1298375809?k=20&m=1298375809&s=612x612&w=0&h=TRwuAULfN4SG_suNeUrFOA_51BMgRNpNV6HJV_Cfmu4=)]">
            ...
            <div className="text-gray-600 body-font  px-20">
                <div className="container mx-auto flex md:flex-row flex-col items-center px-12 ">
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        <img className="object-cover object-center rounded mt-[-80px] h-full " alt="hero" src={doctors} />
                    </div>
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center ml-8">
                        ...
                        <div className="flex justify-center">
                            <button className="inline-flex text-white bg-gradient-to-r from-secondary to-primary border-0 p-2 focus:outline-none rounded text-lg uppercase font-bold">Get Started</button>
                        </div>
                    </div>
